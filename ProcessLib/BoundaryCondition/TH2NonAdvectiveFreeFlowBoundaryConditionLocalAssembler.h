...
{
struct TH2NonAdvectiveFreeFlowBoundaryConditionData
{
...
template <typename ShapeFunction, typename IntegrationMethod,
          unsigned GlobalDim>
class TH2NonAdvectiveFreeFlowBoundaryConditionLocalAssembler final
...
public:
    ...
    TH2NonAdvectiveFreeFlowBoundaryConditionLocalAssembler(
        ...
        TH2NonAdvectiveFreeFlowBoundaryConditionData const& data)
                  ...
                  GlobalMatrix* /*Jac*/) override
    {
        ...
        for (unsigned ip = 0; ip < n_integration_points; ip++)
        {
            ...
            int const pv_index = indices[0] % 4;

            NodalVectorType const neumann_node_values =
                -boundary_permeability_node_values *
                _data.process
                    .getFluxTH2(bulk_element_id, pv_index, bulk_element_point,
                                t, x)
                    .dot(_surface_normal);
...
private:
    ...
    TH2NonAdvectiveFreeFlowBoundaryConditionData const& _data;
