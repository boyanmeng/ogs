    ...
    unsigned const shapefunction_order)
{
    ...
    config.checkConfigParameter("type",
                                "TH2NonAdvectiveFreeFlowBoundary");
    ...
    auto const boundary_permeability_name =
        //! \ogs_file_param{prj__process_variables__process_variable__boundary_conditions__boundary_condition__TH2NonAdvectiveFreeFlowBoundary__parameter}
    ...
    return std::make_unique<TH2NonAdvectiveFreeFlowBoundaryCondition>(
